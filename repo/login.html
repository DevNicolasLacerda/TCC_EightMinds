    ...
    <header>
        <nav class="nave">
            <nav class="navigation">
                <input class="btnLogin-popup" type="button" onclick="window.location = 'index.php';" value="Voltar">
            </nav>
        </nav>
        ...
        <form action="" method="post">
            ...
            <div class="form-box login">
                ...
                <div class="lembredemim">
                    <label><input type="checkbox">Lembre-se mim</label>
        ...
        <div class="form-box register">
            ...
            <form action="#">
              ...
              <div class="input-box">
                ...
                <div class="input-box">
                  <input type="password" id="confirsenha" required>
