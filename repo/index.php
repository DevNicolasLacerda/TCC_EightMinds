...
<head>
    ...
    <link rel="icon" href="img/20220920_115033_0000-removebg-preview.png">
    <!-- fonte -->
...
<body>
    ...
    <noscript>Por favor, ative o JavaScript para utilizar este site</noscript>
            <header>
                  <a href="index.html"><h2 class="logo">Eight Minds</h2></a>
                  <nav id="nav">
                      <ul class="nav_links">
                        ...
                        <button type="button" onclick="menuShow()" aria-label="Abrir menu" 
                        aria-haspopup="true" aria-controls="nav-links" aria-expanded="false" 
                        id="btn-mobile" class="btn-mobile"><span id="hamburger"></span></button>
                  </nav>
                  
                  <input class="btn_contato" type="button" onclick="window.location = 'login.html';" value="Sign-up">
            </header>
            ...
            <div class="mobile-menu">
                  <ul class="nav-links-mobile">
                        ...
                        <li><a href="games.html">Games</a></li>
                        <li><a href="contato.html">Contato</a></li>
                        <input class="btnLogin-popup" type="button" onclick="window.location = 'login.php';" value="Sign-up">
                  </ul>
            </div>
    ...
    <div class="mobile-menu">
        ...
        <input class="btnLogin-popup" type="button" onclick="window.location = 'login.html';" value="Sign-up">
  </div>
    ...
    <section id="promo" class="flex">
        <div class="container">
            ...
            <h2>Nome do jogo</h2>
            <p class="text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Soluta cupiditate molestias ad quia
